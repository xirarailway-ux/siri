...
async function upsertUser(profile) {
  ...
  if (idx >= 0) {
    ...
    d.users.push({ _id: uuid(), tg_id: profile.tg_id, username: profile.username, first_name: profile.first_name, last_name: profile.last_name, credits: 0, is_blocked: 0, created_at: new Date().toISOString(), credit_expires_at: null, last_generation_at: null })
  }
  write(d)
